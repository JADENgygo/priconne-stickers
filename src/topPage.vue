<template>
	<div class="uk-container uk-margin-top uk-text-center">
		<ul class="uk-list uk-list-disc list">
			...
			<li class="uk-link-text"><router-link to="/cheese">チーズお守り大作戦</router-link></li>
			<li class="uk-link-text"><router-link to="/forest">森の臆病者と聖なる学舎の異端児</router-link></li>
			<li class="uk-link-text"><router-link to="/angel">授けの財団と聖なる学舎の異端児</router-link></li>
		</ul>
	</div>
</template>
<script>
