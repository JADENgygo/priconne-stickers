	...
	content: {[key: string]: {[key: string]: string[]}} = {
		...
		'clan-battle': {
			names: [
				...
				'ライデン', 'ネプテリオン', 'アクアリオス', 'バリジスク', 'メサルティム', 'ティタノタートル', 'ミノタウロス', 'スピリットホーン', 'ツインピッグス', 'シードレイク', 'カルキノス', 'ムーバ', 'オルレオン'
			],
			stickers: [
				...
				'./img/clan_battle/sea_drake.webp', './img/clan_battle/karkinos.webp', '../img/clan_battle/muba.webp', '../img/clan_battle/orleon.webp'
			]
		},
		'scramble': {
			names: [
