	...
	content: {[key: string]: {[key: string]: string[]}} = {
		...
		'album': {
			names: [
				...
				'カスミ (マジカル)', 'カヤ', 'キャル', 'キャル (プリンセス)', 'キョウカ', 'クウカ', 'クウカ (オーエド)', 'クリスティーナ', 'クルミ', 'グレア', 'クロエ', 'クロエ (聖学祭)', 'コッコロ', 'コッコロ (プリンセス)', 'サレン', 'ジータ', 'シェフィ', 'シオリ',
			...
			stickers: [
				...
				'./img/album/io.webp', './img/album/inori.webp', './img/album/inori_timetravel.webp', './img/album/iriya.webp', './img/album/eriko.webp', './img/album/kaori.webp', './img/album/kasumi.webp', './img/album/kasumi_magical.webp', './img/album/kaya.webp', './img/album/kyaru.webp', './img/album/kyaru_princess.webp', './img/album/kyouka.webp', './img/album/kuuka.webp',
